...
public class SeventScrLoad extends AppCompatActivity {
    mgdUtil tools;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sevent_scr_load);
        tools = SeventhGlobalCFG.getTools(this);
        ...
        splashUI.createSplashUI(this, SeventhContent.class, R.raw.loading);
    }
}